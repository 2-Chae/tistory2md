# tistory2md
html로 구성된 tistory 블로그 글을 markdown 파일로 백업하는 프로그램입니다. 직접 사용하기 위해 급하게 작성한 프로그램이므로 퀄리티가 떨어질 수 있습니다. 실행 중 오류로 인해 종료가 되면 다시 실행시켜 시도해보시기 바랍니다.
...
#### 저장 위치
오른쪽의 ... 버튼을 눌러 새로운 디렉터리를 설정하시면 됩니다. 하지만 실행파일과 같은 위치를 추천합니다. 또한 저장위치에 tistory2md.exe가 포함되면 그 부분만 지워주세요. 
...
## 발생할 수 있는 문제
- 제가 표를 사용하지 않아 표를 제대로 저장 못할 수 있습니다. 백업 후 md 파일 확인 필수입니다.
